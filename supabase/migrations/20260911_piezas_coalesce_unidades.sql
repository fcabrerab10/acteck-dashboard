-- 2026-09-11 · Piezas: la carga del ERP del 2026-09-10 trajo la columna Unidades vacía
-- (63,787 renglones de 2026 con unidades NULL) y facturacion_clientes quedó con piezas = 0.
-- Regla nueva en todas las medidas: COALESCE(unidades, piezas, 0). Unidades sigue siendo
-- la columna oficial del director; Piezas es el respaldo cuando el export no la trae.
