...
// ═══════════════════════════════════════════════════════════════════
export default function SellInPcel({ clienteKey }) {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const [fact, rdmp, ct, sod] = await Promise.all([
        ...
        // PCEL: sell out por sku/mes desde la view agregada (no hay sellout_detalle)
  ...
  // Sell Out por sku + agregado (PCEL: view agregada por sku/mes)
