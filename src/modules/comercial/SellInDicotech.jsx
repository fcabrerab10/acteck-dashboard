...
export default function SellInDicotech({ clienteKey }) {
  ...
  const filasSKU = useMemo(() => {
    ...
    for (const r of facturacion) {
      ...
      const sku = r.sku;
      if (!acc.has(sku)) acc.set(sku, { sku, piezas: Array(12).fill(0), montos: Array(12).fill(0), montoSI: 0, piezasSI: 0 });
    ...
    return rows;
  }, [facturacion, roadmapMap, busqueda, orden, anio, mesActual, familiaFilter, unidad]);
