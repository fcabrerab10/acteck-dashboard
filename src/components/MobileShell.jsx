...
//     Bottom: [Dirección] [Comercial] [Interno] [Axon]
//
//   Cliente mode (con cliente activo):
//     Header: [🔍]  [Cliente pill · más round]                    [FC avatar]
//     Bottom: [Home] [SI] [SO] [Mkt] [Pagos] [Cart]
//
...
export default function MobileShell({
  ...
  const [openSheet, setOpenSheet] = useState(null); // 'direccion'|'comercial'|'interno'|'axon'|'yo'|'switcher'|null
